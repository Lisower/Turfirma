namespace Turfirma
{
    partial class ModalFormSeasonsDelete
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            labelDown.Location = new Point(170, 210);
            labelDown.Name = "labelDown";
            labelDown.Size = new Size(64, 25);
            labelDown.TabIndex = 37;
            labelDown.Text = "Сезон";
            // 
            // buttonConfirm
            // 
            ...
            buttonConfirm.Location = new Point(298, 292);
            ...
            buttonCancel.Location = new Point(298, 359);
            ...
            labelMain.Location = new Point(132, 52);
            labelMain.Name = "labelMain";
            labelMain.Size = new Size(525, 47);
            labelMain.TabIndex = 34;
            labelMain.Text = "Удалить информацию о сезоне";
            ...
            labelUp.Location = new Point(170, 146);
            labelUp.Name = "labelUp";
            labelUp.Size = new Size(491, 25);
            labelUp.TabIndex = 33;
            labelUp.Text = "Вы уверены, что хотите удалить информацию о сезоне";
            // 
            // ModalFormSeasonsDelete
            // 
            ...
            Name = "ModalFormSeasonsDelete";
            Text = "ModalFormSeasonsDelete";
            ResumeLayout(false);
            PerformLayout();
        }
